...
<footer class="site-footer">
    <div class="container">
        <div class="site-footer__inner">
                            ...
                            <?php if ( ! empty( $link ) && ! empty( $avatar_url ) ) : ?>
                                <li class="site-footer__social">
                                    <a
                                        ...
                                        aria-label="<?php echo esc_attr( $avatar_alt ? $avatar_alt : __( 'Social link', 'business-website' ) ); ?>"
                                    >
                                        <img
            ...
            <nav class="site-navigation" aria-label="<?php esc_attr_e( 'Primary navigation', 'business-website' ); ?>">
                <?php
                wp_nav_menu(
                    array(
