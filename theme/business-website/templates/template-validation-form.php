...
$feedback = business_website_get_validation_form_feedback();
			...
			<div class="validation-form-page__inner">
				<div class="validation-form-page__heading">
					...
					<p class="validation-form-page__subtitle">
						<?php esc_html_e( 'Leave your name and Ukrainian mobile phone number. The form validates the data and sends it to the connected CRM services.', 'business-website' ); ?>
					</p>
				</div>

				<?php if ( 'success' === $feedback['status'] ) : ?>
					<div class="validation-form-page__message validation-form-page__message--success" role="status">
						<?php esc_html_e( 'Thank you. Your data was validated and the CRM flow was started successfully.', 'business-website' ); ?>
					</div>
				<?php endif; ?>
				...
				<form class="validation-form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" novalidate>
					<input type="hidden" name="action" value="business_website_validation_form">
					...
					<?php wp_nonce_field( 'business_website_validation_form', 'business_website_validation_form_nonce' ); ?>

					<div class="validation-form__field validation-form__field--honeypot" aria-hidden="true">
						<label for="contact_website"><?php esc_html_e( 'Website', 'business-website' ); ?></label>
					...
					<div class="validation-form__field">
						<label for="contact_name"><?php esc_html_e( 'Name', 'business-website' ); ?></label>
						<input
							id="contact_name"
							type="text"
							name="contact_name"
							value="<?php echo esc_attr( $name ); ?>"
							placeholder="<?php esc_attr_e( 'Olena', 'business-website' ); ?>"
							autocomplete="name"
							required
						>
					</div>
					...
					<div class="validation-form__field">
						<label for="contact_phone"><?php esc_html_e( 'Phone', 'business-website' ); ?></label>
						<input
							id="contact_phone"
							type="tel"
							name="contact_phone"
					...
					<button class="validation-form__submit button" type="submit">
						<?php esc_html_e( 'Send', 'business-website' ); ?>
					</button>
				</form>
			</div>
		</div>
