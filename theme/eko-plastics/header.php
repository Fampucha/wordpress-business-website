...
<header class="site-header">
    <div class="container site-header__inner">
        ...
        <nav class="site-navigation" aria-label="<?php esc_attr_e( 'Header navigation', 'eko-plastics' ); ?>">
            <?php
            wp_nav_menu(
                array(
                    ...
                    'fallback_cb'    => false,
                    'walker'         => new Eko_Plastics_Header_Menu_Walker(),
                )
            );
            ?>
        </nav>
        ...
        <details
            class="menu-toggle"
            aria-label="<?php esc_attr_e( 'Open menu', 'eko-plastics' ); ?>"
        >
    ...
    <nav class="navigation-mobile" aria-label="<?php esc_attr_e( 'Mobile navigation', 'eko-plastics' ); ?>">
        <?php
        wp_nav_menu(
            array(
                'theme_location' => 'header-menu',
